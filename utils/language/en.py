LANG = {
    "ui": {
        ...
        "faq_cost_answer": "It is completely free. Enjoy!",
        "faq_time_question": "How long does it take?",
        "faq_time_answer": "Around 10 to 15 minutes depending on server load.",
        "faq_delivery_question": "Where will I receive the storybook?",
        "faq_delivery_answer": "At the email address you enter in the form. If you don't see it in your inbox, kindly check your Spam or Promotions folder.",
        "faq_delivery_error_question": "What if I don't receive the storybook?",
